...
function openMenuCasier()
Citizen.Trace('open choix ceh')
    Menu.item = itemMenuCasier
    Menu.isOpen = true
     Menu.initMenu()
end
...
itemMenuCasier = {
    ...
    ['Items'] = { 
        ...
        {['Title'] = 'Prendre Lampe torche',['Function'] = givearme, weapon = GetHashKey("WEAPON_FLASHLIGHT"), ammo=200, text = "une lampe torche"},
        {['Title'] = 'Prendre Extincteur',['Function'] = givearme, weapon = GetHashKey("WEAPON_FIREEXTINGUISHER"),ammo=200, text = "un extincteur"},
		--{['Title'] = 'Prendre Tazer',['Function'] = givearme, weapon = GetHashKey("WEAPON_STUNGUN"),ammo=200, text = "un tazer"},
		--{['Title'] = 'Deposer Tazer',['Function'] = removearme, weapon = GetHashKey("WEAPON_STUNGUN"),ammo=200, text = "un tazer"}
		{['Title'] = 'Deposer Lampe torche',['Function'] = removearme, weapon = GetHashKey("WEAPON_FLASHLIGHT"), ammo=200, text = "une lampe torche"},
        {['Title'] = 'Deposer Extincteur',['Function'] = removearme, weapon = GetHashKey("WEAPON_FIREEXTINGUISHER"),ammo=200, text = "un extincteur"},
		{['Title'] = 'Tenue : Manches Courtes',['Function'] = TenueChemise},
		{['Title'] = 'Tenue : Directeur',['Function'] = TenueDirecteur}
    }
}
...
itemMenuChoixCar = {
    ...
    ['Items'] = {
        {['Title'] = 'Ambulance Petite', ['Function'] = invokeVehicle, type = 1, livery = 0 },
        {['Title'] = 'Ambulance Moyenne', ['Function'] = invokeVehicle, type = 9, livery = 4 },
        {['Title'] = 'Ambulance Longue', ['Function'] = invokeVehicle, type = 10, livery = 4 },
        {['Title'] = 'Sedans médecin', ['Function'] = invokeVehicle, type = 5, livery = 4 },
        {['Title'] = 'Coupes médecin', ['Function'] = invokeVehicle, type = 6, livery = 4 },
        {['Title'] = 'SUV médecin', ['Function'] = invokeVehicle, type = 7, livery = 4 },
        {['Title'] = 'Van', ['Function'] = invokeVehicle, type = 8, livery = 4 },
        {['Title'] = 'SUV Sauveteur', ['Function'] = invokeVehicle, type = 3, livery = 0 },
        {['Title'] = '4x4 Sauveteur', ['Function'] = invokeVehicle, type = 4, livery = 3 },
		{['Title'] = 'Ranger mon véhicule', ['Function'] = invokeVehicle, type = -1 },
    }
}
itemMenuChoixHelico = {
    ...
    ['Items'] = {
        ...
        {['Title'] = 'Ranger le vehicule', ['Function'] = invokeVehicle, type = -2},
    }
}
--====================================================================================
--  Option Menu
