...
local compacts = {
    {name = "Blista", costs = 4000, model = "blista", vMax = "72.43", accel = "57.5", frein = "20"}, 
    ...
    {name = "Kalahari", costs = 800, model = "kalahari", vMax = "72.43", accel = "55", frein = "20"},
...
local coupes = {
    ...
    {name = "Oracle XS", costs = 21000, model = "oracle", vMax = "80.48", accel = "67.5", frein = "30"},
    {name = "Oracle", costs = 38000, model = "oracle2", vMax = "80.48", accel = "65", frein = "30"},
    {name = "Ruiner", costs = 31000, model = "ruiner", vMax = "83.17", accel = "82.5", frein = "33.33"},
    {name = "Sentinel XS", costs = 22000, model = "sentinel", vMax = "76.19", accel = "52.5", frein = "30"},
    {name = "Sentinel Cabrio", costs = 24000, model = "sentinel2", vMax = "76.19", accel = "52.5", frein = "30"},
    {name = "Schwarzer", costs = 32000, model = "Schwarzer", vMax = "77.8", accel = "65", frein = "20"},
...
local sports = {
    ...
    {name = "Banshee", costs = 115000, model = "banshee", vMax = "79.41", accel = "85", frein = "33.33"}, 
    {name = "Bestia GTS", costs = 195000, model = "bestiagts", vMax = "83.17", accel = "80", frein = "33.33"}, 
    {name = "Blista Compact", costs = 15000, model = "blista2", vMax = "70.82", accel = "57.5", frein = "18.33"}, 
    ...
    {name = "Comet SR", costs = 250000, model = "Comet5", vMax = "77.8", accel = "65", frein = "13.33"}, 
    ...
    {name = "Drift Tampa", costs = 200000, model = "tampa2", vMax = "80.48", accel = "82.5", frein = "16.67"},
    {name = "Elegy", costs = 35000, model = "elegy2", vMax = "81.56", accel = "82.5", frein = "16.67"}, 
    {name = "Elegy Rétro", costs = 150000, model = "elegy", vMax = "79.41", accel = "42.5", frein = "33.33"},
    {name = "Feltzer", costs = 155000, model = "feltzer2", vMax = "82.09", accel = "85", frein = "26.67"}, 
    ...
    {name = "Jester(Racecar)", costs = 210000, model = "jester2", vMax = "84.78", accel = "77.5", frein = "31.67"}, 
    {name = "Khamelion", costs = 52000, model = "khamelion", vMax = "75.12", accel = "37.5", frein = "30"}, 
    ...
    {name = "Massacro(Racecar)", costs = 205000, model = "massacro2", vMax = "83.81", accel = "91", frein = "30"}, 
    {name = "Neon", costs = 150000, model = "Neon", vMax = "77.8", accel = "65", frein = "13.33"},
    {name = "Omnis", costs = 47000, model = "omnis", vMax = "81.56", accel = "76.25", frein = "33.33"},
    {name = "Pariah", costs = 230000, model = "Pariah", vMax = "77.8", accel = "65", frein = "13.33"}, 
    {name = "Penumbra", costs = 17000, model = "penumbra", vMax = "75.12", accel = "55", frein = "26.67"}, 
    {name = "Rapid GT", costs = 150000, model = "rapidgt", vMax = "81.56", accel = "90", frein = "33.33"}, 
    {name = "Rapid GT Cabrio", costs = 160000, model = "rapidgt2", vMax = "81.56", accel = "90", frein = "33.33"}, 
    {name = "Raiden", costs = 95000, model = "Raiden", vMax = "77.8", accel = "65", frein = "13.33"},
    {name = "Schafter V12", costs = 80000, model = "schafter3", vMax = "80.48", accel = "75", frein = "31.67"}, 
    {name = "Schafter LWB", costs = 85000, model = "schafter4", vMax = "76.19", accel = "50", frein = "28.33"}, 
    {name = "Seven-70", costs = 200000, model = "seven70", vMax = "85.31", accel = "83.75", frein = "33.33"}, 
    {name = "Specter", costs = 195000, model = "specter", vMax = "80.48", accel = "83.75", frein = "33.33"}, 
    {name = "Specter Custom", costs = 225000, model = "specter2", vMax = "80.48", accel = "83.75", frein = "33.33"}, 
    {name = "Sultan", costs = 55000, model = "sultan", vMax = "77.8", accel = "65", frein = "13.33"}, 
    {name = "Surano", costs = 110000, model = "surano", vMax = "83.17", accel = "85", frein = "33.33"}, 
    {name = "Tropos", costs = 56000, model = "tropos", vMax = "81.56", accel = "56.25", frein = "23.33"}, 
    {name = "Verlierer", costs = 180000, model = "verlierer2", vMax = "80.48", accel = "83.75", frein = "33.33"}, 

}

local sportclassics = {
    {name = "190Z", costs = 125000, model = "Z190", vMax = "80.48", accel = "70", frein = "22"},
    {name = "Casco", costs = 195000, model = "casco", vMax = "81.02", accel = "80", frein = "20"}, 
    {name = "Cheetah Classique", costs = 275000, model = "Cheetah2", vMax = "80.48", accel = "70", frein = "22"},
    {name = "Coquette Classique", costs = 185000, model = "coquette2", vMax = "81.02", accel = "85", frein = "16.67"},
    {name = "Infernus classique", costs = 290000, model = "infernus2", vMax = "80.21", accel = "82.5", frein = "16.67"}, 
    {name = "GT500", costs = 145000, model = "gt500", vMax = "77.8", accel = "65", frein = "20"}, 
    {name = "Mamba", costs = 200000, model = "mamba", vMax = "79.41", accel = "85", frein = "16.67"},  
    {name = "Manana", costs = 42000, model = "manana", vMax = "69.75", accel = "40", frein = "8.33"},
    {name = "Monroe", costs = 100000, model = "monroe", vMax = "80.48", accel = "70", frein = "22"},  
    ...
    {name = "Savestra", costs = 80000, model = "Savestra", vMax = "80.48", accel = "70", frein = "22"},
    {name = "Sentinel Classique", costs = 25000, model = "Sentinel3", vMax = "80.48", accel = "70", frein = "22"},
    ...
    {name = "Turismo Classique", costs = 325000, model = "Turismo2", vMax = "80.48", accel = "70", frein = "22"},
    {name = "Viseris", costs = 215000, model = "Viseris", vMax = "80.48", accel = "70", frein = "22"},
...
local supercars = {
    ...
    {name = "Autarch", costs = 1900000, model = "Autarch", vMax = "80.48", accel = "83.75", frein = "33.33"},
    {name = "Banshee 900R", costs = 160000, model = "banshee2", vMax = "80.48", accel = "86.88", frein = "33.33"}, 
    {name = "Bullet", costs = 180000, model = "bullet", vMax = "81.56", accel = "82.5", frein = "26.67"}, 
    {name = "Cheetah", costs = 475000, model = "cheetah", vMax = "82.09", accel = "80", frein = "26.67"}, 
    {name = "Cyclone", costs = 500000, model = "Cyclone", vMax = "80.48", accel = "83.75", frein = "33.33"},
    ...
    {name = "FMJ", costs = 1900000, model = "fmj", vMax = "84.99", accel = "91.38", frein = "36.67"}, 
    ...
    {name = "Itali GTB Custom", costs = 1150000, model = "italigtb2", vMax = "85.31", accel = "84.14", frein = "37"}, 
    {name = "Nero", costs = 1150000, model = "nero", vMax = "85.85", accel = "84.38", frein = "33.33"}, 
    {name = "Nero Custom", costs = 1250000, model = "nero2", vMax = "85.85", accel = "84.38", frein = "33.33"}, 
    {name = "Osiris", costs = 1000000, model = "osiris", vMax = "85.31", accel = "88.5", frein = "33.33"}, 
    {name = "RE-7B", costs = 1300000, model = "le7b", vMax = "86.38", accel = "92.75", frein = "36.67"}, 
    {name = "Ruston", costs = 350000, model = "ruston", vMax = "85.47", accel = "89", frein = "37.3"}, 
    {name = "Reaper", costs = 825000, model = "reaper", vMax = "85.31", accel = "91.25", frein = "36.67"}, 
    {name = "Revolter", costs = 750000, model = "revolter", vMax = "80.48", accel = "83.75", frein = "33.33"}, 
    {name = "Sultan RS", costs = 200000, model = "sultanrs", vMax = "79.41", accel = "82.5", frein = "33.33"}, 
    {name = "T20", costs = 1100000, model = "t20", vMax = "85.31", accel = "88.5", frein = "33.33"}, 
    {name = "Tempesta", costs = 650000, model = "tempesta", vMax = "84.24", accel = "90", frein = "33.33"}, 
    {name = "Turismo R", costs = 1550000, model = "turismor", vMax = "83.17", accel = "88.25", frein = "40"}, 
    {name = "Tyrus", costs = 1200000, model = "tyrus", vMax = "86.38", accel = "92.75", frein = "40"}, 
    {name = "Vacca", costs = 450000, model = "vacca", vMax = "81.56", accel = "75", frein = "33.33"}, 
    {name = "Visione", costs = 1700000, model = "Visione", vMax = "80.48", accel = "83.75", frein = "33.33"},
    {name = "Voltic", costs = 400000, model = "voltic", vMax = "77.8", accel = "90", frein = "33.33"}, 
    {name = "XA-21", costs = 1400000, model = "xa21", vMax = "86.12", accel = "92.5", frein = "40"}, 
...
local muscle = {
    {name = "Blade", costs = 16000, model = "blade", vMax = "77.8", accel = "81", frein = "26.67"}, 
    {name = "Buccaneer Custom", costs = 82000, model = "buccaneer", vMax = "78.34", accel = "70", frein = "26.67"}, 
    {name = "Chino Custom", costs = 85000, model = "chino", vMax = "75.12", accel = "70", frein = "26.67"}, 
    {name = "Coquette BlackFin", costs = 135000, model = "coquette3", vMax = "81.02", accel = "85", frein = "16.67"}, 
    {name = "Dominator", costs = 35000, model = "dominator", vMax = "77.8", accel = "72.5", frein = "26.67"}, 
    {name = "Dukes", costs = 95000, model = "dukes", vMax = "77.26", accel = "80", frein = "26.67"}, 
    {name = "Faction", costs = 25000, model = "faction", vMax = "75.12", accel = "70", frein = "26.67"}, 
    {name = "Faction Custom", costs = 50000, model = "faction2", vMax = "75.12", accel = "70", frein = "26.67"}, 
    {name = "Gauntlet", costs = 18000, model = "gauntlet", vMax = "77.8", accel = "75", frein = "30"}, 
    {name = "Hermes", costs = 180000, model = "Hermes", vMax = "77.8", accel = "75", frein = "30"},
    ...
    {name = "Picador", costs = 6500, model = "picador", vMax = "72.43", accel = "55", frein = "26.67"}, 
    {name = "Sabre Turbo", costs = 15000, model = "sabregt", vMax = "75.12", accel = "70", frein = "26.67"}, 
    {name = "Sabre Custom", costs = 80000, model = "sabregt2", vMax = "75.12", accel = "70", frein = "26.67"}, 
    {name = "Tampa", costs = 15000, model = "tampa", vMax = "75.12", accel = "67.5", frein = "26.67"}, 
    --{name = "Tornado Rusty", costs = 6500, model = "tornado3", vMax = "75.12", accel = "67.5", frein = "26.67"}, 
    {name = "Tornado", costs = 20000, model = "tornado2", vMax = "75.12", accel = "67.5", frein = "26.67"}, 
    {name = "Tornado Custom", costs = 85000, model = "tornado5", vMax = "75.12", accel = "67.5", frein = "26.67"}, 
    --{name = "Virgo", costs = 25000, model = "virgo", vMax = "75.12", accel = "70", frein = "26.67"},
    {name = "Virgo Custom", costs = 95000, model = "virgo2", vMax = "75.12", accel = "70", frein = "26.67"}, 
    {name = "Vigero", costs = 12000, model = "vigero", vMax = "75.12", accel = "72.5", frein = "26.67"}, 
    {name = "Voodoo Custom", costs = 70000, model = "voodoo", vMax = "75.12", accel = "72.5", frein = "26.67"},
    {name = "SlamVan Custom", costs = 80000, model = "slamvan3", vMax = "75.12", accel = "72.5", frein = "26.67"}, 
}

local toutterrain = {
    {name = "Bifta", costs = 20000, model = "bifta", vMax = "72.97", accel = "65", frein = "23.33"}, 
    ...
    {name = "Dubsta 6x6", costs = 150000, model = "dubsta3", vMax = "73.51", accel = "70", frein = "20"}, 
    {name = "Dune Buggy", costs = 18000, model = "dune", vMax = "72.43", accel = "62.5", frein = "21"}, 
    {name = "Mesa", costs = 95000, model = "mesa3", vMax = "72.43", accel = "62.5", frein = "20.67"}, 
    ...
    {name = "Sandking XL", costs = 33000, model = "sandking", vMax = "69.75", accel = "50", frein = "20"}, 
    --{name = "The Liberator", costs = 6000000, model = "monster", vMax="59.02", accel="100", frein= "21.67"},
    {name = "Trophy Truck", costs = 130000, model = "trophytruck2", vMax = "75.12", accel = "84.75", frein = "10"}, 
    {name = "Trophy Truck Dune", costs = 130000, model = "trophytruck2", vMax = "75.12", accel = "84.75", frein = "10"}, 
...
local suv = {
    ...
    {name = "Cavalcade 2", costs = 25000, model = "cavalcade2", vMax = "68.14", accel = "50", frein = "20"}, 
...
local vans = {
    {name = "Bison", costs = 15000, model = "bison", vMax = "69.75", accel = "50", frein = "20"}, 
    ...
    {name = "Minivan Custom", costs = 10500, model = "minivan", vMax = "67.07", accel = "37.5", frein = "13.33"},
    {name = "Moonbean Custom", costs = 10500, model = "moonbean2", vMax = "67.07", accel = "37.5", frein = "13.33"},  
    --{name = "Paradise", costs = 15500, model = "paradise", vMax = "69.75", accel = "42.5", frein = "13.33"}, 
    {name = "Rumpo XL", costs = 20000, model = "rumpo3", vMax = "69.75", accel = "45", frein = "10"}, 
    {name = "Speedo", costs = 10000, model = "speedo", vMax = "69.75", accel = "45", frein = "10"}, 
    {name = "Surfer", costs = 15000, model = "surfer", vMax = "53.66", accel = "25", frein = "10"}, 
    {name = "Youga Classique", costs = 12000, model = "youga2", vMax = "64.39", accel = "35", frein = "10"}, 
    {name = "FoodTruck", costs = 25000, model = "taco", vMax = "64.39", accel = "35", frein = "10"}, 
}

local sedans = {
	{name = "Asea", costs = 1200, model = "asea", vMax="72.43", accel="57.5", frein="20" },
    ...
    {name = "Primo Custom", costs = 10000, model = "primo2", vMax = "75.12", accel = "50", frein = "30"}, 
    ...
    {name = "Stretch", costs = 400000, model = "stretch", vMax = "72.43", accel = "42.5", frein = "26.67"}, 
    ...
    {name = "Tailgater", costs = 13000, model = "tailgater", vMax = "77.8", accel = "50", frein = "30"}, 
    {name = "Warrener", costs = 9000, model = "warrener", vMax = "75.12", accel = "61.25", frein = "31.67"}, 
    {name = "Washington", costs = 8000, model = "washington", vMax = "75.12", accel = "50", frein = "30"}, 
...
local motos = {
    ...
    {name = "Akuma", costs = 33000, model = "AKUMA", vMax = "77.8", accel = "100", frein = "40"}, 
     {name = "Avarus", costs = 15000, model = "avarus", vMax = "80.48", accel = "75", frein = "46.67"}, 
    ...
    --{name = "Chimera", costs = 30000, model = "chimera", vMax = "80.48", accel = "75", frein = "46.67"}, 
    ...
    {name = "Defiler", costs = 35000, model = "defiler", vMax = "80.48", accel = "75", frein = "46.67"}, 
    --{name = "Diabolus", costs = 25000, model = "diablous", vMax = "76.46", accel = "78", frein = "40"}, 
    {name = "Diabolus Custom", costs = 55000, model = "diablous2", vMax = "76.46", accel = "78", frein = "40"}, 
    ...
    {name = "Faggio", costs = 100, model = "faggio2", vMax = "48.29", accel = "25", frein = "13.33"}, 
    --{name = "FCR", costs = 30000, model = "fcr", vMax = "77.8", accel = "100", frein = "40"}, 
    {name = "FCR Custom", costs = 32000, model = "fcr2", vMax = "69.75", accel = "52.5", frein = "40"}, 
    {name = "Gargoyle", costs = 45000, model = "gargoyle", vMax = "78.87", accel = "78.13", frein = "36.67"}, 
    {name = "Hakuchou", costs = 22000, model = "hakuchou", vMax = "81.56", accel = "78.75", frein = "46.67"}, 
    --{name = "Hakuchou Drag", costs = 25000, model = "hakuchou2", vMax = "80.48", accel = "75", frein = "46.67"}, 
    {name = "Hexer", costs = 9000, model = "hexer", vMax = "72.43", accel = "65", frein = "33.33"}, 
    {name = "Innovation", costs = 65000, model = "innovation", vMax = "72.43", accel = "80", frein = "33.33"}, 
    {name = "Lectro", costs = 33000, model = "lectro", vMax = "75.12", accel = "70", frein = "40"}, 
    ...
    {name = "Rat Bike", costs = 10000, model = "ratbike", vMax = "80.48", accel = "75", frein = "46.67"}, 
    --{name = "Ruffian", costs = 16000, model = "ruffian", vMax = "75.12", accel = "85", frein = "36.67"}, 
    {name = "Sanchez", costs = 10000, model = "sanchez", vMax = "63.31", accel = "70", frein = "36.67"}, 
    ...
    {name = "Vortex", costs = 25000, model = "vortex", vMax = "80.48", accel = "75", frein = "46.67"},  
