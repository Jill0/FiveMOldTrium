...
client_scripts {
    ...
    '[metiers]/Water/water_client.lua', 
    '[metiers]/Fermiers/fermiers_client.lua', 
    '[metiers]/Mineurs/mineurs_client.lua',
	'[metiers]/Prisonniers/prisonniers_client.lua',	
    '[metiers]/Arboriculteurs/arboriculteurs_client.lua', 
	'[metiers]/Glaciers/glaciers_client.lua', 
