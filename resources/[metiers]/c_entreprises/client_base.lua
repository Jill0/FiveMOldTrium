...
RegisterNetEvent('metiers:init')
AddEventHandler('metiers:init',function()
reloading = true
end)
-- DEBUG
--[[
...
function InitMarker()
	  for _, v in pairs(entreprises) do
		if (not v.loop_ignore) and (current_jobid == v.jobid or v.for_all) then
