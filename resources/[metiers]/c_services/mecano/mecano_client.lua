...
local function toogleService()
    ...
    if inService then
		...
		if(GetEntityModel(GetPlayerPed(-1)) == hashSkin) then
			...
			SetPedComponentVariation(GetPlayerPed(-1), 7, 9, 0, 2)			-- pas de collier
			SetPedComponentVariation(GetPlayerPed(-1), 3, 68, 0, 2) -- TORSO
			SetPedComponentVariation(GetPlayerPed(-1), 11, 117, 0, 2) -- TORSO2
			SetPedComponentVariation(GetPlayerPed(-1), 4, 92, 20, 2) -- LEGS
