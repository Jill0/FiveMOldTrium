    ...
    while true do
        Citizen.Wait(3000)
			if not(isCopInService) then
				...
				RemoveWeaponFromPed(ply, GetHashKey("WEAPON_COMPACTLAUNCHER"))
				RemoveWeaponFromPed(ply, GetHashKey("WEAPON_RAILGUN"))
				--RemoveWeaponFromPed(ply, GetHashKey("WEAPON_ASSAULTSNIPER"))
				
				
				RemoveWeaponFromPed(ply, GetHashKey("WEAPON_HOMINGLAUNCHER"))
				RemoveWeaponFromPed(ply, GetHashKey("WEAPON_PROXMINE"))
				RemoveWeaponFromPed(ply, GetHashKey("WEAPON_FIREWORK"))
				RemoveWeaponFromPed(ply, GetHashKey("WEAPON_BULLPUPRIFLE"))
				RemoveWeaponFromPed(ply, GetHashKey("WEAPON_MOLOTOV"))
				
				
				RemoveWeaponFromPed(ply, GetHashKey("WEAPON_STICKYBOMB"))
				RemoveWeaponFromPed(ply, GetHashKey("WEAPON_SMOKEGRENADE"))
				RemoveWeaponFromPed(ply, GetHashKey("WEAPON_BZGAS"))
				RemoveWeaponFromPed(ply, GetHashKey("WEAPON_RPG"))
			end
	end
end)
