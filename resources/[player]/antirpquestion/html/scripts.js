$(document).ready(function(){
  ...
  var goodAnswer = [];
  var questionUsed = [];
  var nbQuestionToAnswer = 8; // don't forget to change the progress bar max value in html
  var nbAnswerNeeded = 7; // out of nbQuestionToAnswer
  var nbPossibleQuestions = 11; //number of questions in database questions.js
  ...
  $(".btnQuestion").click(function(){
      $.post('http://antirpquestion/question', JSON.stringify({}));
  });
  $(".btnClose").click(function(){
      $.post('http://antirpquestion/close', JSON.stringify({}));
  });
  $(".btnKick").click(function(){
      $.post('http://antirpquestion/kick', JSON.stringify({}));
  });
