$(document).ready(function(){
	...
	function openHelper() { // OUVRIR FENETRE
	...
	function closeHelper() { // FERMER LA FENETRE
		for (var i =1; i < 31; i++) {
			document.getElementById("page" + i).style.display =	"none";
		}
	}

	function nextSlide() { // FENETRE SUIVANTE (ordre croissant)
		...
		} else if (document.getElementById("page6").style.display === "block") {
			document.getElementById("page6").style.display = "none";
			document.getElementById("page7").style.display = "block";
		} else if (document.getElementById("page7").style.display === "block") {
			document.getElementById("page7").style.display = "none";
			document.getElementById("page8").style.display = "block";
		} else if (document.getElementById("page8").style.display === "block") {
			document.getElementById("page8").style.display = "none";
			document.getElementById("page9").style.display = "block";
		} else if (document.getElementById("page9").style.display === "block") {
	...
	window.onload = function(e){ // FONCTION PRINCIPALE
		window.addEventListener('message', function(event){
			var item = event.data;
			if (item.openHelper === true) {
				openHelper();
			}
			if (item.openHelper === false) {
				closeHelper();
			}
			if (item.nextSlide === true) {
				nextSlide();
			}
			if (item.previousSlide === true) {
				previousSlide();
			}
		});
	};
