local twentyfourseven_shops = {
    ...
    {['x'] = 1166.5, ['y'] = 2708.86, ['z'] = 38.1577},
    {['x'] = 2678.45, ['y'] = 3280.81, ['z'] = 55.24},
    {['x'] = 1689.14, ['y'] = 2528.65, ['z'] = 45.56} -- cantine prison
}
...
AddEventHandler("food:selection", function(data)
    ...
    if(exports["vdk_inventory"]:notFull() == true and exports["vdk_inventory"]:tryFull(1) == true) then
