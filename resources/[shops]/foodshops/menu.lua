...
Menu.item = {
    ['Title'] = 'Magasin',
    ['Items'] = {
        {['Title'] = 'Sandwich', ['Event'] = 'food:selection', ['itemid'] = 30, ['price'] = 50, ['Close'] = false},
        {['Title'] = 'Barre chocolatée', ['Event'] = 'food:selection', ['itemid'] = 110, ['price'] = 20, ['Close'] = false},
        -- {['Title'] = 'Eau', ['Event'] = 'food:selection',['itemid']=6,['price']=10,['Close']= false},
        -- {['Title'] = 'Jus d\'orange', ['Event'] = 'food:selection',['itemid']=108,['price']=35,['Close']= false},
    {['Title'] = 'Ice tea', ['Event'] = 'food:selection', ['itemid'] = 109, ['price'] = 36, ['Close'] = false}}}
    --====================================================================================
    --  Option Menu
    --====================================================================================
    ...
    function Menu.draw()
        ...
        AddTextComponentString(menu.Title .. " (".. exports["vdk_inventory"]:getPods() .. "/100)")
        ...
        for pos, value in pairs(menu.Items) do
            ...
            AddTextComponentString(value.Title .. " " .. value.price .. "~g~$ ~w~(vous en avez ~r~" .. exports["vdk_inventory"]:getQuantity(value.itemid) .. "~w~)")
