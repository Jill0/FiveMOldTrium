...
RegisterNUICallback("player", function(data, cb)
	...
	if action == "heal" then
		...
		TriggerServerEvent('mellotrainer:HealMsg')
	...
	elseif action == "armor" then
		...
		TriggerServerEvent('mellotrainer:ArmorMsg')
	...
	elseif action == "god" then
		...
		TriggerServerEvent('mellotrainer:GodMsg')
		...
		if playerPed then
			...
			if(featurePlayerInvisibleUpdated)then
				...
				if featurePlayerInvisible then
					TriggerServerEvent('mellotrainer:InvisibilityMsg', true)
					SetEntityVisible(playerPed, false, 0)
				else
					TriggerServerEvent('mellotrainer:InvisibilityMsg', false)
