...
local prefix = "^2[Trium RP]^0"
local suffix = "^0."
local messages = {
    'Micro obligatoire et présence Discord exigée : ^4discord.gg/t5tXee7',
    'Nom/Prénom RP ^1obligatoire sur Steam !',
    'Un troll ? Un non-respect des régles ? un bug bloquant ? utilisez ^3/report',
    'Redémarrage automatique des serveurs tous les jours à 6h00 et 20h00 (heure Française)'
}
local ignorelist = {
    "ip:127.0.0.1"
}
