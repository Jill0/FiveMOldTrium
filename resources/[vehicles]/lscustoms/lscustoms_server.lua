...
RegisterServerEvent("lscustoms:checkIfMeca")
AddEventHandler("lscustoms:checkIfMeca", function()
	TriggerEvent("es:getPlayerFromId", source, function(player)
		...
		TriggerClientEvent('lscustoms:isMecaOrNot',player.source, isMecaOrNot)
	end)
end)
