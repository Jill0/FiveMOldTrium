...
RegisterServerEvent("lvc_TogDfltSrnLights_s")
AddEventHandler("lvc_TogDfltSrnLights_s", function(newstate)
	TriggerClientEvent("lvc_TogDfltSrnLights_c", -1, source, newstate)
end)
